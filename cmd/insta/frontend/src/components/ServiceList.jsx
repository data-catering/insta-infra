...
function ServiceList({ 
  ...
  const servicesWithStatus = services.map(service => ({
    ...service,
    name: service.Name || service.name,  // ServiceList expects lowercase name
    type: service.Type || service.type,  // ServiceList expects lowercase type  
    status: statuses[service.Name || service.name] || 'stopped', // Default to stopped if no status
    dependencies: service.Dependencies || service.recursive_dependencies || [], // Include dependencies from backend
  }));
        ...
        <div className="card-body">
          <div className="loading-container">
            <div className="loading-content">
              ...
              <p className="loading-subtext">Discovering available infrastructure services</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card-header">
        <div className="card-title">
          ...
          {isLoading && services.length > 0 && (
            <div className="loading-indicator" title="Refreshing services...">
