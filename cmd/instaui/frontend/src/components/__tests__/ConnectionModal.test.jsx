...
describe('ConnectionModal', () => {
  ...
  test('renders modal with service name when open', () => {
    ...
    expect(screen.getByText('Connection Details - postgres')).toBeInTheDocument()
  ...
  test('displays error when connection is not available', () => {
    ...
    expect(screen.getByText('Service connection information is not available.')).toBeInTheDocument()
  ...
  test('does not display web URL section when not available', () => {
    ...
    expect(screen.queryByText('Web URL:')).not.toBeInTheDocument()
  })
